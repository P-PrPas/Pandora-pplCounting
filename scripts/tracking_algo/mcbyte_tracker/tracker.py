...
try:
    ...
    import torchreid
    # ponytail: pip's torchreid (0.2.5) doesn't register torchreid.utils as a
    # real submodule (it's an attribute alias for torchreid.reid.utils), so
    # the straight `from torchreid.utils import FeatureExtractor` upstream
    # uses raises ModuleNotFoundError on this install - go through the
    # package attribute instead, same object either way.
